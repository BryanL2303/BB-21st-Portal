...
/*To display the correct answer for the question
*/
  ...
  return(
    <div className='selected-question'>
      ...
      {question != null && question.question_type == "MCQ" && options.map((option) => {
        return (
          <div>
            <input type='radio' value={option.id} name={question.id} disabled defaultChecked={question.correct}></input>
      ...
      {question != null && question.question_type == "MRQ" && options.map((option) => {
        return (
          <div>
            <input type='checkbox' value={option.id} name={question.id} disabled defaultChecked={question.correct}></input>
            <label id={question.id} className='question__option'>{option.answer}</label>
          </div>
        )
      })}
      {question != null && question.question_type == "Open-ended" && options.map((option) => {
        return (
          <input disabled defaultValue={rubric}></input>
        )
      })}
    </div>
  )

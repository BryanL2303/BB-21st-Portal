...
const McqOptionsForm = () => {
  ...
  return(
    <div className='mcq-options-segment'>
      <label>Add in up to 8 options and set the correct answer</label>
      <br/>
      <input type='radio' value='1' name='option'></input>
      <input className='create-question-form__option' placeholder='Option 1'></input>
      <br/>
      <input type='radio' value='2' name='option'></input>
      <input className='create-question-form__option' placeholder='Option 2'></input>
      <br/>
      {number >= 3 && <input type='radio' value='3' name='option'></input>}
      ...
      {number >= 3 && <br/>}
      {number >= 4 && <input type='radio' value='4' name='option'></input>}
      ...
      {number >= 4 && <br/>}
      {number >= 5 && <input type='radio' value='5' name='option'></input>}
      ...
      {number >= 5 && <br/>}
      {number >= 6 && <input type='radio' value='6' name='option'></input>}
      ...
      {number >= 6 && <br/>}
      {number >= 7 && <input type='radio' value='7' name='option'></input>}
      ...
      {number >= 7 && <br/>}
      {number >= 8 && <input type='radio' value='8' name='option'></input>}

...
const AwardTracker = () => {
  ...
  return(
    <div className='award-tracker'>
      ...
      <div>
        <Popup className='account-filter-popup' trigger={<button><img className="filter-account-img" src="/packs/media/packs/general/filter-line-icon-75b677be9dfe5ecb38441d43e9bed3d6.png" alt='Filter'></img></button>} position="bottom left">

  ...
  return(
    <div className='award-tracker'>
      ...
      {["Electives", "IPA", "SPA", "Founders"].map((special_award) => {
        return (
          <div key={special_award} style={{width: "100%"}}>{!checkingMilestone && <AwardAttainmentTable award_name={special_award} boys={boys} checked={checked} toggleAttainment={toggleAttainment} electivePoints={electivePoints} ipaAttained={ipaAttained} spaAttained={spaAttained} />}</div>
        )
      })}
    </div>
  )

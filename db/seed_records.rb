...
award = Award.new(badge_name: 'Target', recommended_level: '1', has_mastery: 0, custom_description: 0,
                  has_custom_columns: 0, has_results: true, has_pass: 0, badge_requirements:
...
10. Company organisation and ranks",
                  results_description:
                 "Boys completed 2 induction parades and are oriented with basic knowledge of The Boys' Brigade")
award.save

award = Award.new(badge_name: 'Christian Education', recommended_level: '3', has_mastery: false,
                  custom_description: false, has_custom_columns: false, has_results: true, has_pass: false,
                  badge_requirements:
                 "DEDICATED CHRISTIAN EDUCATION SESSIONS

- Awarded to Boys who have undergone a minimum of 24 sessions of an approved Christian Education syllabus over a period
 of 3 years.
- Companies opting for this track are to send a copy of the following to the BBHQ’s Programmes Department for approval
 before the implementation of the Christian Education syllabus:
...
3. Samples of worksheets and activities.",
                  results_description:
                 'Boys have undergone over 24 sessions of approved Christian Education syllabus over a period of
                  3 years.')
award.save

award = Award.new(badge_name: 'Total Defence', has_mastery: true)
award.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Bronze', recommended_level: '1', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false, mastery_requirements:
...
Officers may download the latest TD Lesson Plans from
 Officers Portal > Resources > Seniors > New SP Curriculum > Total Defence.",
                      results_description:
                     "Boys have completed SLS lessons, played GOTC II, designed and shared a new \"Action\" card for
                      the game and also completed an introduction to CPR-AED as part of school's PE curriculum.")
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Silver', recommended_level: '2', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false, mastery_requirements:
...
2. Taught at least a pair of peers how to play the GOTC II card game or assisted in the facilitation of gameplay of at
 least a pair of peers at a GOTC II gameplay session and completed a reflection. (90 mins)

Officers may download the latest TD Lesson Plans from
 Officers Portal > Resources > Seniors > New SP Curriculum > Total Defence.",
                      results_description:
                     'Boys have submitted storyboard for N.E.mation! on one of the 6 TF pillers and also facilitated
                      a pair of peers in GOTC II gameplay.')
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Gold', recommended_level: '3', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false, mastery_requirements:
                     "Awarded to Boys who have attained TD (Silver) and:

1. Initiated, planned, and executed a TD-related VIA project that benefits the  community at large
 (individually or in groups) and completed a reflection or joined a volunteer scheme approved by Nexus.
2. Completed CPR-AED certification. (4 hours) In addition, Boys may choose to complete an optional Psychological First
 Aid certification. (8 hours)

Officers may download the latest TD Lesson Plans from
 Officers Portal > Resources > Seniors > New SP Curriculum > Total Defence.",
                      results_description: 'Boys have planned and executed a TD related VIA project benefiting the
                       community and also completed CPR-AED certification.')
mastery.save

award = Award.new(badge_name: 'Community Spiritedness', has_mastery: true)
award.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: true,
                      has_custom_columns: true, has_results: true, has_pass: false,
                      description_cue:
                     'Title and date of the stakeholder event, also provide a brief description of the stakeholderevent
                      as well as which stakeholder was engaged',
...
3. Raised awareness / participated in an *event with a stakeholder at a level that requires low-level coordination and
 no client interaction. Examples include:
    1. Distributing flyers for a church funfair.
    2. Participating in a parent-child bonding activity run by other organisations (e.g. paintball, trekking,
     futsal/ soccer match).
...
**This event should not coincide with the BB CARES or BBSG event used to fulfill the 15 hours of community service.*",
                      results_description: 'Boys have completed 15 hours of community service through BB CARES or BBSG
                       and also participated in a stakeholder event')
mastery.save
...
custom_column.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '2', custom_description: true,
                      has_custom_columns: true, has_results: true, has_pass: false,
                      description_cue:
                     'Title and date of the stakeholder event, also provide a brief description of the stakeholder
                      event as well as which stakeholder was engaged',
                      mastery_requirements:
...
3. Raised support / provided support to the organising committee in an *event with a stakeholder at a level that
 requires mid-level coordination and some client interaction. Examples include:
    1. Participating in an old clothes collection (e.g. give out pamphlets beforehand and collect old clothes for
     mission trip needs).
    2. Hosting a segment of a parent-child bonding activity / appreciation lunch.
    3. Assisting to pack and deliver goodie bags to the school staff or construction workers working on the school
     expansion program.

**This event should not coincide with the BB CARES or BBSG event used to fulfill the 15 hours of community service.*",
                      results_description: 'Boys have completed 15 hours of community service through BB CARES or BBSG
                       and also supported the organising committee in a stakeholder event')
mastery.save
custom_column = CustomColumn.new(mastery_id: mastery.id, column_title: 'BB Cares hrs')
custom_column.save
custom_column = CustomColumn.new(mastery_id: mastery.id, column_title: 'SGB hrs')
...
custom_column = CustomColumn.new(mastery_id: mastery.id, column_title: 'Role in stakeholder event')
custom_column.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Master', recommended_level: '3', custom_description: true,
                      has_custom_columns: true, has_results: true, has_pass: false,
                      description_cue: 'Title and date of the stakeholder event, also provide a brief description of
                       the stakeholderevent as well as which stakeholder was engaged',
                      mastery_requirements:
...
3. Provided direct service / organised and executed an event with a stakeholder at a level that requires high-level
 coordination and close client interaction. Examples include:
    1. Lead a home-spring cleaning project for low-income families that the church is supporting.
    2. Organise and execute a Family Day event where the Boys’ parents are invited to mingle with the Company through
     a series of fun activities.
    3. Partner with a VWO to co-organise an outing for down syndrome or autistic children, with Boys coming alongside
     as helpers during the outing.

**This event should not coincide with the BB CARES or BBSG event used to fulfill the 15 hours of community service.*",
                      results_description: 'Boys have completed FAA duties for BBSG and also organised and executed a
                       stakeholder event')
mastery.save
custom_column = CustomColumn.new(mastery_id: mastery.id, column_title: 'Role in stakeholder event')
custom_column.save
...
award.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      mastery_requirements:
                     "Awarded to Boys who have completed lessons on any 2 of the following 13 global issues selected
                      by BBHQ and completed their reflections*:
...
**Companies may choose to adopt Borton’s Reflection Model (refer to “Additional Notes”) but are free to tailor the
 reflection questions to their Boys.*",
                      results_description: 'Boys have completed lessons on 2 global issues and completed their
                       reflections on the lessons.')
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '2', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      mastery_requirements:
...
2. Completed a guided research and write-up/presentation on any 1 of the above 13 global issues selected by BBHQ.",
                      results_description: 'Boys have completed all 3 keystone lessons followed by a guided research
                       and presentation on 1 of the global issues')
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Master', recommended_level: '3', custom_description: false,
                      has_custom_columns: false, has_results: false, has_pass: false,
                      mastery_requirements:
                     "Awarded to Boys who attained GA (Advanced) and completed a Social Entrepreneurship Project with
                      action plans to solve problems of a chosen topic (from the list of 13 issues). The project’s
                       topic and chosen country/community of interest should be of a global (not local) setting.
                        The project is to be submitted to BBHQ for assessment and may adopt, though not restricted to,
...
2. Completed a 10 km expedition on foot which requires the above 5 lessons to be put into practice.",
                      results_description: 'Boys have completed 5 Adventure lessons and completed 10km expedition on
                       foot, displaying practical competency in the process.')
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '2', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      mastery_requirements:
...
2. Completed a 16 km expedition on foot through which the 10 Adventure lessons (across Basic and Advanced levels) may
 be put into practice.",
                      results_description: 'Boys have completed 5 Adventure lessons and completed 16km expedition on
                       foot, putting into practice everything they have learnt across all 10 Adventure lessons.')
mastery.save
...
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      mastery_requirements:
                     "Awarded to Boys who have completed the following 10 Drill lessons and passed the practical
                      assessment:
...
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '2', custom_description: false,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      mastery_requirements:
                     "Awarded to Boys who have attained Drill Basic and completed the following 10 Drill lessons with
                      practical competency in the specified commands:
...
Drill (Advanced) does not require a practical assessment and can be attained as long as the Boy attends all 10 Drill
 (Advanced) lessons and can execute the specified drill movements.",
                      results_description: "Boys' have completed the curriculum and can execute the specified drill
                       movements")
mastery.save
...
award.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: true,
                      has_custom_columns: false, has_results: true, has_pass: true,
                      description_cue: 'Description of the Arts and Crafts activity done.',
                      mastery_requirements:
                     "Officers are to facilitate the learning of the badgework and reflection in 4 lessons for each
                      level, inclusive of a Character Excellence value per lesson.

Awarded to Boys who have participated in an Arts or Crafts activity where a minimum of 7 hours of practical work is
 required.")
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '2', custom_description: true,
                      has_custom_columns: false, has_results: true, has_pass: true,
...
Awarded to Boys who have attained the Basic Arts & Crafts award and haveparticipated in an Arts or Crafts activity
 where a minimum of additional 12 hours of practicalwork is required.")
mastery.save

award = Award.new(badge_name: 'Athletics', has_mastery: true)
award.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: false,
                      has_custom_columns: true, has_results: true, has_pass: true,
                      mastery_requirements:
                     "Officers are to facilitate the learning of the badgework and reflection in 2 lessons for each
                      level, inclusive of a Character Excellence value per lesson.
...
Awarded to Boys who have attained the Basic Athletics award and attained Level2 in any two of the events mentioned in
 the table below",
...
award.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '2', custom_description: false,
                      has_custom_columns: false, has_results: false, has_pass: false,
                      mastery_requirements:
                     "Officers are to facilitate reflection and guidance in one pre-course and one post-courseCharacter
                      Excellence lesson.

The list of pre-approved first aid courses is available in the Annex of this document (page 7)
 https://bbsp.notion.site/Personal-Mastery-e8a79eb739934efabf2b0d1481a5f6ae.
...
mastery.save
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '3', custom_description: false,
                      has_custom_columns: false, has_results: false, has_pass: false,
                      mastery_requirements:
                     "Officers are to facilitate reflection and guidance in one pre-course and one post-course
                      Character Excellence lesson.

The list of pre-approved first aid courses is available in the Annex of this document (page 7)
 https://bbsp.notion.site/Personal-Mastery-e8a79eb739934efabf2b0d1481a5f6ae.

Awarded to Boys who (either i. or ii.):
i. attend a 2-day first aid course that includes AED (automated external defibrillator) component, lasting about 15
 hours; or
ii. have attained the Basic First Aid award and attend the 4-hour CPR+AED coursefunded by Temasek Foundation as part
 of the Total Defence programme;
...
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: true,
                      has_custom_columns: false, has_results: true, has_pass: true,
                      description_cue: 'Description of activity and work done.',
                      mastery_requirements:
                     "Officers are to facilitate the learning of the badgework and reflection in 4 lessons for each
                      level, inclusive of a Character Excellence value per lesson.

Awarded to Boys who have participated in a Hobbies activity over a period of at least 3 months, with a minimum of 7
...
Awarded to Boys who have attained the Basic Hobbies award and haveparticipated in a Hobbies activity over a period of
 at least an additional 3 months, with aminimum of additional 12 hours of practical work is required.
...
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: true,
                      has_custom_columns: true, has_results: true, has_pass: true,
                      description_cue: 'Description of instructors and assessment',
                      mastery_requirements:
                     "Officers are to facilitate reflection and guidance in one pre-course and one post-course
                      Character Excellence lesson.

Due to the nature of this activity, it is imperative that all sessions are conducted by trained Rifle Instructors who
 are recognised by the Ministry of Education. This is to ensure proper use of weapons and overall safety of the
  participants and conducting Officers/instructors.
...
mastery = Mastery.new(award_id: award.id, mastery_name: 'Basic', recommended_level: '1', custom_description: true,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      description_cue: 'Description of activities',
                      mastery_requirements:
                     "Officers are to facilitate the learning of the badgework and reflection in 4 lessons for each
                      level, inclusive of a Character Excellence value per lesson.
...
mastery = Mastery.new(award_id: award.id, mastery_name: 'Advanced', recommended_level: '2', custom_description: true,
                      has_custom_columns: false, has_results: true, has_pass: false,
                      description_cue: 'Description of activities and intra/inter company games',
                      mastery_requirements:
                     "Officers are to facilitate the learning of the badgework and reflection in 4 lessons for each
                      level, inclusive of a Character Excellence value per lesson.

Awarded to Boys who have attained the Basic Sportsman award, learnt one other team sport in 4 lessons, and have
 competed in one other intra-Company competition or one inter-Company competition")
mastery.save
...
b. Aimed at providing more opportunities for everyone to try sailing and enliven the Marina Bay area. These sailing
 activities are free and open to the public.
c. Session bookings are opened one month before (i.e. the following month'sregistration will open on the 3rd Monday
...
uniform_component = UniformComponent.new(component_name: 'Haircut', total_score: 3)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Personal Grooming', total_score: 2)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'General', total_score: 3)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Metal parts such as cap badge, badges, haversack loop, slide, button hole and belt
                                    buckle should be shiny and free from stain, rust and mold')
component_field.save

uniform_component = UniformComponent.new(component_name: 'Field Service Cap', total_score: 4)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The field service cap is worn tilted to the right side of the head, two finger
                                    breadths above the right ear and right eyebrow')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 0,
                                     description:
                                   'Missing')
component_field.save

uniform_component = UniformComponent.new(component_name: 'Uniform', total_score: 6)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Boy should wear Uniform Pants of the correct length, i.e. just above the ankles
                                    while standing')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Name Tag', total_score: 3)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The regulation silver name tag with black wordings (80mm x 20mm x 1.5mm Silver
                                    Gravoply nametag) is worn slightly above the left breast pocket on the Uniform
                                     Shirt')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Name tag should be aligned straight and parallel to the horizontal edge of the
                                    left breast pocket, not slanted')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 0,
                                     description:
                                   'Missing')
...
uniform_component = UniformComponent.new(component_name: 'Haversack', total_score: 5)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The white haversack is worn over the right shoulder with the sling passing under
                                    the belt on the left')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The pouch should rest on the left hip with the top edge of the pouch in line with
...
uniform_component = UniformComponent.new(component_name: 'Belt', total_score: 2)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The black leather belt with chrome buckle should be worn fairly tightly around
                                    the waist')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Shoes', total_score: 2)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Socks', total_score: 2)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Socks should be long enough to cover any exposed skin when the knees are bent
                                    (e.g. when seated)')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 0,
                                     description:
...
uniform_component = UniformComponent.new(component_name: "Senior's Lanyard", total_score: 4)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The white lanyard is worn around the left shoulder with the long end to the back,
                                    secured by a knot to prevent it from slipping')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Only white-coloured lanyards are to be worn at all times. No coloured lanyards
                                    are permitted')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 0,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Chevron', total_score: 3)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Chevrons are to be worn on the right arm above the elbow with the V pointing
                                    downwards')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Badges', total_score: 2)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: -1,
                                     description:
                                   'The Anti-Drug Abuse, Heritage, Remembrance Day, Energy Conservation and Civil
                                    Defence badges are worn')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: -1,
                                     description:
...
uniform_component = UniformComponent.new(component_name: 'Left Breast Pocket', total_score: 1)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The Total Defence and Link badges, if awarded, should be worn above the name tag,
...
uniform_component = UniformComponent.new(component_name: 'Left Arm', total_score: 1)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'Only the Senior Proficiency Award, Intermediary Proficiency Award and Juniors
                                    Programme Gold Award (in descending order) are to be worn on the left arm')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 0,
                                     description:
                                   'Missing or wrongly arranged')
...
uniform_component = UniformComponent.new(component_name: 'Cross Belt (SSGs and WOs)', total_score: 3)
uniform_component.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
...
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 1,
                                     description:
                                   'The cross belt’s pouch at the back should be hanging diagonally at the bottom
                                    right side of the upper body, above the leather belt')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 0,
                                     description:
                                   'Missing')
component_field.save
component_field = ComponentField.new(uniform_component_id: uniform_component.id, score: 3,
                                     description:
                                   'Not applicable')
component_field.save

...
class CreateParadesTable < ActiveRecord::Migration[7.0]
    def change
      ...
      create_table :parade_company_announcements do |t|
        t.belongs_to :parade
        t.text :announcement
      ...
      create_table :parade_platoon_programs do |t|
        t.belongs_to :parade
        t.string :level
        t.string :program
      ...
      create_table :parade_platoon_announcements do |t|
        t.belongs_to :parade
        t.string :level
        t.text :announcement
      ...
      create_table :parade_attendances do |t|
        t.belongs_to :parade
